    ...
    <>
      ...
      <div className="container Service__container">
        ...
        <div className="Service__wrapper">
          {
            RolesProtocols.map(({id, icon, title, description, path}) => ( // Fixed: replaced curly braces with parentheses for implicit return
